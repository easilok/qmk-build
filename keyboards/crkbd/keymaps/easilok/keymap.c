...
const key_override_t forward_slash_key_override = ko_make_basic(MOD_MASK_SHIFT, KC_SPC, KC_PSLS);
const key_override_t asterisc_key_override = ko_make_basic(MOD_MASK_SHIFT, KC_ESC, KC_PAST);

// This globally defines all key overrides to be used
const key_override_t **key_overrides = (const key_override_t *[]){
    &delete_key_override,
    &forward_slash_key_override,
    &asterisc_key_override,
