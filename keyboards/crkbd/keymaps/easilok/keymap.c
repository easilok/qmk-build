...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT_split_3x6_3(
        ...
        KC_LSFT,  KC_A, KC_S, LALT_T(KC_D),   KC_F,          LGUI_T(KC_G),   KC_H,   KC_J,         LALT_T(KC_K),   KC_L,   RSFT_T(KC_SCLN),  KC_RBRC,
        KC_LCTL, KC_Z, KC_X, KC_C,           KC_V,           KC_B,           KC_N,   KC_M,         KC_COMM,        KC_DOT, KC_SLSH,  KC_BSLS,
                             KC_LGUI,        MO(_SYM),       KC_ESC,         KC_SPC, MO(_NUM),        LALT_T(KC_ENT)
    ),
	[_NUM] = LAYOUT_split_3x6_3(
        ...
        KC_LCTL, KC_7, KC_8, KC_9,      KC_HOME,    KC_END,  KC_LEFT,        KC_DOWN, KC_UP,   KC_RGHT, KC_EQL,  LALT_T(KC_ENT),
                             KC_LGUI,   MO(_META),  KC_ESC, RALT_T(KC_SPC), KC_TRNS, KC_LALT
    ),
	[_SYM] = LAYOUT_split_3x6_3(
        ...
        KC_LCTL, LSFT(KC_NUHS), KC_PSLS, KC_PAST,       KC_GRV,     RALT(KC_2), KC_NUHS,       KC_DLR,  RALT(KC_7), RALT(KC_0), LSFT(KC_COMM), KC_EURO,
                                         KC_LGUI,       KC_TRNS,    KC_ESC,    KC_SPC,        MO(_META),   LALT_T(KC_ENT)
    ),
