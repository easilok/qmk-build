...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT_split_3x6_3(
        ...
        KC_LCTL, KC_Z,    KC_X,     KC_C,    KC_V,       KC_B,   KC_N,   KC_M,       KC_COMM,   KC_DOT,   KC_SLSH,  KC_BSLS,
                                    KC_LGUI, E_LT(_NUM), KC_ESC, KC_SPC, E_LT(_SYM), RTHUMB_3
    ),
	[_NUM] = LAYOUT_split_3x6_3(
        KC_GRV,  KC_1, KC_2, KC_3,      KC_4,       KC_5,    KC_6,           KC_7,        KC_8,    KC_9,     KC_0,    KC_BSPC,
        KC_LSFT, KC_4, KC_5, KC_6,      KC_0,       KC_NUBS, KC_LEFT,        KC_UP,       KC_DOWN, KC_RIGHT, KC_QUOT, KC_RALT,
        KC_LCTL, KC_7, KC_8, KC_9,      KC_HOME,    KC_END,  KC_RBRC,        KC_DOWN,     KC_MINS, KC_SLSH,  KC_EQL,  RTHUMB_3,
                             KC_LGUI,   MO(_NUM),   KC_ESC,  RALT_T(KC_SPC), E_LT(_META), KC_LGUI
    ),
	[_SYM] = LAYOUT_split_3x6_3(
        ...
        KC_LCTL, LSFT(KC_NUHS), KC_PSLS, KC_PAST,       KC_GRV,       RALT(KC_2), KC_NUHS,       KC_DLR,    RALT(KC_7), RALT(KC_0), LSFT(KC_COMM), KC_EURO,
                                         KC_LGUI,       E_LT(_META),  KC_ESC,     KC_SPC,        MO(_SYM),  RTHUMB_3
    ),
	[_META] = LAYOUT_split_3x6_3(
        ...
        RGB_RMOD, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD,   KC_NO,   KC_VOLD, KC_NO,     KC_NO,   KC_POWER,KC_PGDN, KC_ENT,
